    ...
    public static class DefaultPropertyManager
    {
        ...
        public static readonly ReadOnlyDictionary<string, Property<double>> DefaultDoubleProperties =
            DictOf(
                ...
                ("xp_modifier_kill_tier1", new Property<double>(0.4, "Scales the amount of xp received by players for killing creatures below level 28.")),
                ("xp_modifier_kill_tier2", new Property<double>(0.4, "Scales the amount of xp received by players for killing creatures between level 28 and level 65.")),
                ("xp_modifier_kill_tier3", new Property<double>(0.3, "Scales the amount of xp received by players for killing creatures between level 65 and level 95.")),
                ("xp_modifier_kill_tier4", new Property<double>(0.3, "Scales the amount of xp received by players for killing creatures between level 95 and level 110.")),
                ("xp_modifier_kill_tier5", new Property<double>(0.2, "Scales the amount of xp received by players for killing creatures between level 110 and level 135.")),
                ("xp_modifier_kill_tier6", new Property<double>(0.2, "Scales the amount of xp received by players for killing creatures above level 135.")),
                ("xp_modifier_reward_tier1", new Property<double>(0.5, "Scales the amount of xp received by players for completing quests of level 28 or below, or for unspecified level quests while being under level 16.")),
                ("xp_modifier_reward_tier2", new Property<double>(0.4, "Scales the amount of xp received by players for completing quests between level 28 and level 65, or for unspecified level quests while being between level 16 and 36.")),
                ("xp_modifier_reward_tier3", new Property<double>(0.3, "Scales the amount of xp received by players for completing quests between level 65 and level 95, or for unspecified level quests while being between level 36 and 56.")),
                ("xp_modifier_reward_tier4", new Property<double>(0.3, "Scales the amount of xp received by players for completing quests between level 95 and level 110, or for unspecified level quests while being between level 56 and 76.")),
                ("xp_modifier_reward_tier5", new Property<double>(0.2, "Scales the amount of xp received by players for completing quests between level 110 and level 135, or for unspecified level quests while being between level 76 and 96.")),
                ("xp_modifier_reward_tier6", new Property<double>(0.2, "Scales the amount of xp received by players for completing quests of level 135 and above, or for unspecified level quests while being over level 96.")),
