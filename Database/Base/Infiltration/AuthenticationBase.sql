...
--
-- Host: localhost    Database: ace_auth_infiltration
-- ------------------------------------------------------
...
--
-- Current Database: `ace_auth_infiltration`
--

/*!40000 DROP DATABASE IF EXISTS `ace_auth_infiltration`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `ace_auth_infiltration` /*!40100 DEFAULT CHARACTER SET utf8mb4 */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `ace_auth_infiltration`;
...
/*
-- Query: SELECT * FROM ace_auth_infiltration.accesslevel
